# com-chilipeppr-cpws-mao
ChiliPeppr Workspace Mehmet (grbl 1.1j compatible)

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / MAO grbl 1.1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-cpws-mao |
| Name                  | Workspace / MAO grbl 1.1 |
| Description           | ChiliPeppr Workspace Mehmet (grbl 1.1j compatible) |
| chilipeppr.load() URL | http://raw.githubusercontent.com/maozcan/cpws-mao/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/maozcan/cpws-mao |
| Github URL            | http://github.com/maozcan/cpws-mao |
| Test URL              | https://preview.c9users.io/maozcan/cpws-mao/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/maozcan/cpws-mao/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-cpws-mao"], // the id you gave your workspace
      function(myCpwsMao) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / MAO grbl 1.1 just got loaded.", myCpwsMao);
        myCpwsMao.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-cpws-mao"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / MAO grbl 1.1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"ChiliPeppr Workspace Mehmet (grbl 1.1j compatible)"</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/maozcan/cpws-mao/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/maozcan/cpws-mao"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/maozcan/cpws-mao"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://cpws-mao-maozcan.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
