...
cprequire_test(["inline:com-chilipeppr-cpws-mao"], function(ws) {
    ...
    $('title').html("MAO grbl 1.1 Workspace");
...
cpdefine("inline:com-chilipeppr-cpws-mao", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-cpws-mao", // Make the id the same as the cpdefine id
        name: "Workspace / MAO grbl 1.1", // The descriptive name of your widget.
        desc: `ChiliPeppr Workspace Mehmet (grbl 1.1j compatible)`,
